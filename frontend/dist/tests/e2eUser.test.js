...
describe("Test E2E de l'application", function() {
    ...
    it("devrait charger la page d'accueil", /*#__PURE__*/ _async_to_generator(function() {
        ...
        return _ts_generator(this, function(_state) {
            switch(_state.label){
                ...
                case 1:
                    _state.sent(); // Modifier l'URL en fonction de votre application
                    return [
                        4,
                        driver.getTitle()
                    ];
    ...
    it("devrait se connecter avec succ\xe8s", /*#__PURE__*/ _async_to_generator(function() {
        return _ts_generator(this, function(_state) {
            switch(_state.label){
                case 0:
                    return [
                ...
                case 1:
                    ...
                    return [
                        4,
                        driver.findElement(By.id("pseudo")).sendKeys("nolannd")
                    ];
                case 2:
                    _state.sent();
                    return [
                        4,
                        driver.findElement(By.id("password")).sendKeys("nolannd")
                    ];
                case 3:
                    _state.sent();
                    return [
...
//# sourceMappingURL=e2eUser.test.js.map